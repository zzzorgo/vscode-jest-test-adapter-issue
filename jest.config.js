...
module.exports = {
    ...
    // cacheDirectory: "/Users/anyakey/jest_300o9c",
    ...
    'moduleNameMapper': {
        '\\.(gif|ttf|eot|svg|png|jpg)$': '<rootDir>/__mocks__/emptyMock.js',
        '\\.(css|less|sass|scss)$': '<rootDir>/__mocks__/emptyMock.js'
      },
    ...
    transformIgnorePatterns: [
      '.*node_modules/(?!(platform-components|@yandex-int|bering|education-icons)/.*\\.(jsx|js|ts|tsx)$)'
    ]
